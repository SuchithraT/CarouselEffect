...
class SecondActivity : AppCompatActivity() {
        ...
        override fun onPageSelected(position: Int) {
            ...
            if (position == layouts.size - 1) {
                ...
                anim.addUpdateListener { animation ->
                    iv_blobTouch.scaleX = animation.animatedValue as Float
                    iv_blobTouch.scaleY = animation.animatedValue as Float
                    iv_blobCard.scaleX = animation.animatedValue as Float
                    iv_blobCard.scaleY = animation.animatedValue as Float
                }
                anim.repeatCount = 1
                ...
                anim.addUpdateListener { animation ->
                    iv_blobTouch.scaleX = animation.animatedValue as Float
                    iv_blobTouch.scaleY = animation.animatedValue as Float
                    iv_blobFace.scaleX = animation.animatedValue as Float
                    iv_blobFace.scaleY = animation.animatedValue as Float
                }
                anim.repeatCount = 1
                anim.repeatMode = ValueAnimator.REVERSE
                anim.start()
    ...
    fun blobMobileAnim(view: View){
        val scale = resources.displayMetrics.density

        val anim1: ObjectAnimator = ObjectAnimator.ofFloat(view, "x", 220.0f * scale, 20.0f * scale)
        val anim2: ObjectAnimator = ObjectAnimator.ofFloat(view, "y", 220.0f * scale, 20.0f * scale)
